...
The supported locale set is the product's existing twelve-locale contract. English keeps
the unprefixed canonical route; every other locale uses its registered segment. Do not
copy another project's locale inventory or create a second SEO/content registry.
